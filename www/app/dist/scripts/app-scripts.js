...
(function (window, angular, undefined) {
  ...
  function CommitmentResource($http, $q, BASE_URL, Commitment, RecipientNeed, RecipientNeedStatus) {
  ...
  angular.module("safefamilies")
    .service("CommitmentResource", ["$http", "$q", "BASE_URL", "Commitment", "RecipientNeed", "RecipientNeedStatus", CommitmentResource]);
